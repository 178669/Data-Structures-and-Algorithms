...
#include <string>
#include <vector>
#include <cctype>//library for easy checking of if a char is an A-Z letter
//cctype checks both upper and lowercase 👍
class FindPalindrome{

private:
	// private stuff that you define and implement goes here...
	std::vector<std::string> pals;//vector of all words
	std::vector<std::vector<std::string>> storepals;//vector of all strings that a palindrome makes

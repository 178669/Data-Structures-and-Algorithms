...
private:
	...
	int lastop;//1 for start,2 for content, 3 for end, 4 for dec, 5 for empty
	bool hack=false;//i think this has no function in my implementation, but I'm scared to change it because it finally 
	//got it working after like 5 hours of edge-case testing
...
public:
	...
	bool parseTokenizedInput();//why are the comments below completely different from document instructions??
